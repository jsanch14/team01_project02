<?php $parentTitle = "Pokémon Generations"; $currentTitle = "Generations V-VII"; $separator = " | "; include "inc/top.inc";?>
		...
		<article class="col-md-12">
			...
			<div class="gen-block">
				<h3>Generation V (2010-2013)</h3>

				<div class="gen-content">	
					<iframe width="100%" src="https://www.youtube.com/embed/LLVYhlFQIug" frameborder="0" allowfullscreen></iframe>
					<p>The fifth generation of Pokémon began on September 18, 2010 with the release of Pokémon Black and White in Japan. They were then released in North America, Europe, and Australia in March 2011. They were released on the Nintendo DS, the same console as its predecessing generation.</p>
			...
			<iframe width="560" height="315" class="img-responsive gen-img" src="https://www.youtube.com/embed/Gq0nlGs2IaE" frameborder="0" allowfullscreen></iframe>
